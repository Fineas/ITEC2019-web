          ...
          <div class="modal-dialog" role="document" style="top: 5em;">
            <div class="modal-content" tabindex="2">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <a href="http://localhost/ITEc/register.php?q=0"><img id="side-vec" src="img/buyer.png"></a>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <a href="http://localhost/ITEc/register.php?q=1"><img id="side-vec" src="img/seller.png"></a>
                  </div>
                </div>
              </div>
            </div>
