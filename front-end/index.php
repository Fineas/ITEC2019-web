...
<body>
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        <h1 class="masthead-heading mb-0" style="text-shadow: 4px 4px 4px #000000;">One Page Wonder</h1>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <a id="modal-body-type">Buyer</a>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <a id="modal-body-type">Seller</a>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <a href="http://localhost/ITEc/register.php?q=0"><img src="img/buyer.png"></a>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <a href="http://localhost/ITEc/register.php?q=1"><img src="img/seller.png"></a>
                  </div>
                </div>
              </div>
            </div>
