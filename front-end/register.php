...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    <div class="container">
      <a class="navbar-brand" href="index.php">TITLU UNKNOWN</a>
      ...
      <div class="row align-items-center">
        ...
        <script>
          function do_register(){
            ...
            var to_send = 'http://52.47.147.159/api_main.php?q='+'yBuMKjnrVEeKN5Hf78zr'+'&'+"d="+type+'//'+email+'//'+name+'//'+surname+'//'+phone+'//'+addr+'//'+reg_pub+'//'+pass;
            $.ajax({
            type: 'GET',
            url: to_send,
            // data: {email,pass},
            ...
            success: function(data){
              ...
              if(data == '0'){
                ...
                message = '';
                // alert(data);
                window.location.replace('localhost:80/ITEc/login.php');
              }
